...
class BackofficeEtapeController extends AbstractController
{
    ...
    {
        return $this->render('backoffice_home/etape/index.html.twig', ['etapes' => $etapeRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backoffice_home/etape/new.html.twig', [
            'etape' => $etape,
    ...
    {
        return $this->render('backoffice_home/etape/show.html.twig', ['etape' => $etape]);
    }
    ...
    public function edit(Request $request, Etape $etape): Response
    {
        ...
        return $this->render('backoffice_home/etape/edit.html.twig', [
            'etape' => $etape,
            'form' => $form->createView(),
        ]);
    }
