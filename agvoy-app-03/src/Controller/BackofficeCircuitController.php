...
class BackofficeCircuitController extends AbstractController
{
    ...
    {
        return $this->render('backoffice_home/circuit/index.html.twig', ['circuits' => $circuitRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backoffice_home/circuit/new.html.twig', [
            'circuit' => $circuit,
    ...
    {
        return $this->render('backoffice_home/circuit/show.html.twig', ['circuit' => $circuit]);
    }
    ...
    public function edit(Request $request, Circuit $circuit): Response
    {
        ...
        return $this->render('backoffice_home/circuit/edit.html.twig', [
            'circuit' => $circuit,
            'form' => $form->createView(),
        ]);
    }
