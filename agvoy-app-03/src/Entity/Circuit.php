...
class Circuit
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\ProgramationCircuit", mappedBy="circuit", orphanRemoval=true)
     */
    ...
    /**
     * @return Collection|ProgramationCircuit[]
     */
    ...
    public function addProgrammation(ProgramationCircuit $programmation): self
    {
    ...
    public function removeProgrammation(ProgramationCircuit $programmation): self
    {
        if ($this->programmations->contains($programmation)) {
