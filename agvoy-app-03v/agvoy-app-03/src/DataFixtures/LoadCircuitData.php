...
class LoadCircuitData extends Fixture
{
	...
	private function getCircuitData()
	{
	    // todo = [title, completed];
	    yield [1, 'Andalousie', 'Espagne', 'Grenade', 'Séville', 4];
	    yield [2, 'VietNam', 'VietNam', 'Hanoi', 'Hô Chi Minh', 4];
	    yield [3, 'Ile de France', 'France', 'Paris', 'Paris', 2];
	    yield [4, 'Italie', 'Italie', 'Milan', 'Rome', 4];
